<%-- 
    Document   : ash
    Created on : Jul 15, 2017, 12:35:22 PM
    Author     : cesc
--%>
...
<html>
    ...
    <body style="background-color:#DCDCDC">
        ...
        <br/> <br/> <br/>
        <img src="ash.png" width="64" height="64" align="left" alt="ash_logo"/>
        <br/>
        <h1 style="font-size:300%;text-align:center;font-family:cooperblack">Ash Master</h1>
        <%@ include file="con1.jsp" %>
     <%
PreparedStatement selectTrans = null;
ResultSet rs = null;

selectTrans = connection.prepareStatement("SELECT * FROM ash_mst" );

rs = selectTrans.executeQuery();

              %>   
              <form name="myform0" action="dataash.jsp" method="POST">
                  <div style="overflow-x:auto;">
                      <div style="overflow-y:auto;">
                  <table id="customers" style="text-align:center;background-color:#E6E6FA" align="center" border="1">
                  <tbody>
                      <tr>
                          <td>Product Code</td>
                          <td>Product Name</td>
