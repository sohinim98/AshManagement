<%-- 
    Document   : datatransporter
    Created on : Jul 19, 2017, 12:20:29 PM
    Author     : cesc
--%>
...
<html>
    ...
    <body link="yellow" vlink="greenyellow" alink="red" style="background-color:midnightblue;text-align: center">
        <h1 style="font-size:300%;text-align:center;font-family:cooperblack;color:gold">Transporter Details Modification</h1>
...
selectTrans = connection.prepareStatement("SELECT TRANSPORTER_CODE FROM transporter_mst WHERE TRANSPORTER_CODE = '"+cc+"'" );
...
{ st.executeUpdate("INSERT INTO transporter_mst(TRANSPORTER_CODE, TRANSPORTER_NAME, ENABLED_FLAG) VALUES('"+cc+"','"+cn+"','"+ef+"' )");
        %>
    <br/>
    ...
    <br/> <br/>
        ...
        <p style="text-align: center;font-size:160%">
            <a  href = "transporter.jsp" > Click to view the updated table</a > </p>
<% }
else
{
...
int n1=0;
        selectTrans = connection.prepareStatement("SELECT TRANSPORTER_CODE FROM transporter_mst WHERE TRANSPORTER_CODE = '"+c1+"'" );
...
while (rs1.next())
{
    ...
    n1++;
        ...
        {
            st.executeUpdate("UPDATE transporter_mst SET TRANSPORTER_NAME= '"+c2+"', ENABLED_FLAG='"+e1+"' WHERE TRANSPORTER_CODE = '"+c1+"'");
            f=1;
        }
        else if(res1.equals("Delete") && !c1.equals("") && !c2.equals("") && n1 == 1)
        {
            st.executeUpdate("DELETE FROM transporter_mst WHERE TRANSPORTER_CODE = '"+c1+"' AND TRANSPORTER_NAME = '"+c2+"'");
            f=1;
        }
    }
if(f==1){
...
<%
        ...
        <p style="font-size:120%;color:white;text-align:left"> <br/> <br/> Make sure: </p>
            ...
            <li>The Transporter Code is unique.</li>
        ...
        <a href="transporter.jsp">Click to go back to the table to re-enter data</a>
        </p>
        <% }
}
        %>
